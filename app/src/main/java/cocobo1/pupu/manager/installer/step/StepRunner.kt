package cocobo1.pupu.manager.installer.step
...
import cocobo1.pupu.manager.installer.step.installing.InstallStep
import cocobo1.pupu.manager.installer.step.patching.AddPupuStep
import cocobo1.pupu.manager.installer.step.patching.PatchManifestsStep
import cocobo1.pupu.manager.installer.step.patching.PresignApksStep
import cocobo1.pupu.manager.installer.step.patching.ReplaceIconStep
import cocobo1.pupu.manager.installer.util.LogEntry
import cocobo1.pupu.manager.installer.util.Logger
...
class StepRunner(
    ...
    suspend fun runAll(): Throwable? {
        for (step in steps) {
            ...
            // Add delay for human psychology (aka our stupid minds) and
