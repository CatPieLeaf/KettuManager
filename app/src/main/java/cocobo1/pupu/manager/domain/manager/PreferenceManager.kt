package cocobo1.pupu.manager.domain.manager
...
import cocobo1.pupu.manager.domain.manager.base.BasePreferenceManager
...
class PreferenceManager(context: Context) :
    ...
    var packageName by stringPreference("package_name", "cocobo1.pupu.manager")

    var appName by stringPreference("app_name", "Pupu")
    ...
    var updateDuration by enumPreference("update_duration", UpdateCheckerDuration.DAILY)
